...
mock:
	mockgen -package mockdb -destination db/mock/store.go github.com/blueai2022/appsubmission/db/sqlc Store
...
proto:
	...
	--openapiv2_out=doc/swagger --openapiv2_opt=allow_merge=true,merge_file_name=life_ai \
	proto/*.proto
